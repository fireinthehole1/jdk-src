...
/**
 * AbstractQueue 继承自AbstractCollection
...
public class ArrayBlockingQueue<E> extends AbstractQueue<E>
    ...
    private void enqueue(E x) {
         ...
         * 唤醒一个线程
         *  Condition队列中的第一个线程
         *  {@link java.util.concurrent.locks.AbstractQueuedSynchronizer.ConditionObject#doSignal(AbstractQueuedSynchronizer.Node)}
         */
        notEmpty.signal();
    }
    ...
    void removeAt(final int removeIndex) {
        ...
        final Object[] items = this.items;
        //如果要移除的元素刚好是 取数据的索引，那就重新维护takeIndex
    ...
    /**
     *
     * {@link AbstractQueue#offer(Object)} 的方法
     * 最终调用 {@link ArrayBlockingQueue#offer(Object)}
     *
     * @param e
     * @return
     */
    ...
    public boolean offer(E e) {
        ...
        checkNotNull(e);
        final ReentrantLock lock = this.lock;
        //获取锁 AQS实现锁队列 根据构造函数中的fair决定 公平还是非公平的方式获取锁
        lock.lock();
        try {
            // 如果当前元素个数等于容量,入队失败
    ...
    /**
     * 返回takeIndex处的元素,但并不改变数组和takeIndex
     * @return
     */
    public E peek() {
        final ReentrantLock lock = this.lock;
