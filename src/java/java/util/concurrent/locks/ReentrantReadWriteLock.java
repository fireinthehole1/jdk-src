...
public class ReentrantReadWriteLock
    ...
    abstract static class Sync extends AbstractQueuedSynchronizer {
        ...
        /**
         * 使用低 16 位表示写状态，也就是获取到写锁的次数
         * @param c
         * @return c & 1111111111111111
         */
        ...
        /**
         * tryAcquireShared 只 CAS 获取锁一次，失败了则调用 fullTryAcquireShared，后者会在自旋中不断重试 CAS 获取锁。
         * @param unused
         * @return
         */
        protected final int tryAcquireShared(int unused) {
            ...
            if (exclusiveCount(c) != 0 &&
                ...
                // 如果其他线程持有写锁，则当前线程进入阻塞（写读互斥）
                // 如果当前线程持有写锁，则允许再次获取读锁（支持锁降级）
                return -1;
            // 读锁被获取的次数
            int r = sharedCount(c);
            if (!readerShouldBlock() &&  // 公平性策略校验，若不需要阻塞则进入下一步
